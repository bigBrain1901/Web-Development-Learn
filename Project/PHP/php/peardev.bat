...
FOR %%x IN ("E:\Web-Development-Learn\Project\PHP\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=E:\Web-Development-Learn\Project\PHP\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=E:\Web-Development-Learn\Project\PHP\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=E:\Web-Development-Learn\Project\PHP\php\php.exe"
GOTO :INSTALLED
